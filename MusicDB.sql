...
INSERT INTO RecordLabel VALUES (null, 'Platinum Records');
INSERT INTO RecordLabel VALUES (null, 'Wow Records');
INSERT INTO RecordLabel VALUES (null, 'Cool Records');
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLabel r WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" AND r.RecordLabel = "Wow Records";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLabel r WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" AND r.RecordLabel = "Cool Records";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLabel r WHERE a.ArtistName = "Jay Z" AND g.Label = "Rap" AND r.RecordLabel = "Cool Records";
...
INSERT INTO Album
	SELECT null,
         ...
         RecordLabelId,
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLabel r WHERE a.ArtistName = "Mayer Hawthorne" AND g.Label = "Soul" AND r.RecordLabel = "Cool Records";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLabel r WHERE a.ArtistName = "Mayer Hawthorne" AND g.Label = "Soul" AND r.RecordLabel = "Platinum Records";
...
INSERT INTO Album VALUES (null, "Revolver", '08/05/1966', 2083, 2, 6, 2);
INSERT INTO Album VALUES (null, "Sgt. Pepper's Lonely Hearts Club Band", '06/01/1967', 2392, 2, 6, 2);
INSERT INTO Album VALUES (null, "Magical Mystery Tour", '11/27/1967', 1148, 2, 6, 2);

INSERT INTO Album VALUES (null, 'Screaming for Vengeance', '06/17/1982', 2322, 2, 1, 2);
INSERT INTO Album VALUES (null, 'Point of Entry', '02/26/1981', 2262, 3, 1, 2);
INSERT INTO Album VALUES (null, 'Defenders of the Faith', '01/04/1984', 2383, 1, 1, 2);

INSERT INTO Album VALUES (null, 'Round About Midnight', '03/06/1957', 2327, 1, 24, 4);
INSERT INTO Album VALUES (null, 'Miles Ahead', '10/21/1957', 2132, 2, 24, 4);
INSERT INTO Album VALUES (null, 'Milestones', '09/02/1958', 2856, 3, 24, 4);

INSERT INTO Album VALUES (null, "Moanin' in the Moonlight", '05/14/1959', 2033, 1, 7, 3);
INSERT INTO Album VALUES (null, "Howlin' Wolf", '10/21/1957', 1917, 2, 7, 3);
INSERT INTO Album VALUES (null, "The Howlin' Wolf Album", '09/02/1969', 2459, 2, 7, 3);
...
INSERT INTO Album VALUES (null, "Damaged", '12/05/1981', 2098, 2, 8, 9);
INSERT INTO Album VALUES (null, "TV Party", '07/12/1982', 409, 1, 8, 9);
INSERT INTO Album VALUES (null, "Everything Went Black", '12/03/1982', 3718, 3, 8, 9);
...
JOIN RecordLabel r ON al.RecordLabelId = r.RecordLabelId
